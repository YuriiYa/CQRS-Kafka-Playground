...
namespace Post.Query.Infrastructure.Converters
{
    public class EventJsonConverter : JsonConverter<BaseEvent>
    {
        ...
        public override BaseEvent? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            {
                throw new JsonException("Could not detect the Type Descriminator!");

            }

            var typeDescriminator = typeProperty.GetString();
            ...
            return typeDescriminator switch
            {
                ...
                _=>throw new JsonException($"{typeDescriminator} is not a valid event type!")
            };
